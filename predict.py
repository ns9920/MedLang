...
# BIOBERT_NER_MODEL_DIR = "final_model/ner"
# BIOBERT_RE_MODEL_DIR = "final_model/re"
...
with open('model/NER_config.pkl', 'rb') as f:
    biobert_ner_config = pickle.load(f)

biobert_ner_tokenizer = AutoTokenizer.from_pretrained(
    "dmis-lab/biobert-base-cased-v1.1")

with open('model/NER_pytorch_model.pkl', 'rb') as f:
    biobert_ner_model = pickle.load(f)
...
# Load config.pkl
with open('model/RE_config.pkl', 'rb') as f:
    biobert_re_config = pickle.load(f)

# Load pytorch_model.pkl
with open('model/RE_pytorch_model.pkl', 'rb') as f:
    biobert_re_model = pickle.load(f)
